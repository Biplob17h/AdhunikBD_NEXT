...
const OrderDetails = () => {
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="mx-auto flex max-w-5xl flex-row gap-4 rounded-lg bg-white p-6 shadow-md">
        ...
        <div className="flex-1 border-r pr-4">
          ...
          <p className="text-sm">
            ...
            <span className="ml-2 text-red-500">D-995890-18013</span>
          </p>
          ...
          <p className="text-sm mt-1 flex items-center gap-2">
            <FaClock /> <span className="font-medium">Ticket Created Time:</span> 13 Feb, 2025 09:49 PM
          </p>
          <p className="text-sm mt-1 flex items-center gap-2">
            <FaCalendarAlt /> <span className="font-medium">Delivered Date & Time:</span> Job isn’t delivered yet.
          </p>
          <p className="text-sm mt-1 flex items-center gap-2">
        ...
        <div className="flex-1 border-r px-4">
          ...
          <p className="text-sm flex items-center gap-2">
            <FaUser /> <span className="font-medium">Delivery Name:</span> My Home
          </p>
          <p className="text-sm mt-1 flex items-center gap-2">
            <FaPhone /> <span className="font-medium">Delivery Mobile:</span> +8801678027585
          </p>
          <p className="text-sm mt-1 flex items-start gap-2">
            <FaMapMarkerAlt /> <span className="font-medium">Delivery Address:</span> House 21, Milk Vita Road, Section 7, Mallika R/A, Pallabi, Dhaka
          </p>
        </div>
        ...
        <div className="flex-1 pl-4">
          ...
          <hr className="my-2" />
          <p className="text-sm flex items-center gap-2">
            <FaUser /> <span className="font-medium">Name:</span> MD. Ruhul Amin
          </p>
          <p className="text-sm mt-1 flex items-center gap-2">
            <FaPhone /> <span className="font-medium">Mobile:</span> +8801837250222
          </p>
          <div className="mt-2">
      ...
      {/* Actions */}
      <div className="mt-6 max-w-5xl mx-auto bg-white p-4 rounded-lg shadow-md">
      ...
      <div className="mt-6 max-w-5xl mx-auto bg-white p-4 rounded-lg shadow-md">
        ...
        <div className="mt-4 rounded-lg bg-gray-200 p-4">
          <p className="text-sm flex items-center gap-2">
            <FaCalendarAlt /> <span className="font-medium">Schedule Date:</span> 15-Feb-2025
          </p>
          <p className="text-sm mt-1 flex items-center gap-2">
            <FaClock /> <span className="font-medium">Preferred Time:</span> 10:00 AM - 11:00 AM
          </p>
